...
export class Backend implements backendInterface {
    ...
    async getQuoteOfDay(): Promise<Quote> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuoteOfDay();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getQuotesByCategory(arg0: string): Promise<Array<Quote>> {
        if (this.processError) {
            try {
                const result = await this.actor.getQuotesByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
